class argHandler(dict):
    ...
    def setEnvDefaults(self):
        self.define('env', True, 'Use environment detector *True/False')
        self.define('yolo', False, 'Use yolo True/*False')
        self.define('input', '/home/dfed/Desktop/vlog.mp4', 'path to input video file')
        self.define('output', './output.json', 'path to output JSON file')
        self.define('debug', False, 'Generate debug video True/*False')  
        self.define('debug_out', './output.avi', 'path to output video file')
        self.define('start_frame', 0, 'starting frame')
        self.define('skip_frame', 1, 'skip n frames')
        self.define('end_frame', -1, 'number of frame to process')
        self.define('verbose', True, 'show progress')
